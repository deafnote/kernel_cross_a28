...
#ifdef CONFIG_FB_MSM_MIPI_TCL_TD_TNFW4602_2_VIDEO_MODE
#define LCD_MODULE_NAME "mipi_video_tcl_td_tnfw4602_2_fwvga"
#endif
...
#if defined CONFIG_FB_MSM_MIPI_TCL_TD_TNFW4602_2_VIDEO_MODE
static struct platform_device mipi_dsi_tcl_td_tnfw4602_2_panel_device = {
	.name = "mipi_tcl_td_tnfw4602_2",
	.id   = 0,
	.dev  = {
		.platform_data = &mipi_tcl_td_tnfw4602_2_pdata,
	}
};
#else
...
static struct platform_device *evb_fb_devices[] __initdata = {
	&msm_fb_device,
#if defined CONFIG_FB_MSM_MIPI_TCL_TD_TNFW4602_2_VIDEO_MODE
	&mipi_dsi_tcl_td_tnfw4602_2_panel_device,
#else
