...
static int mipi_video_tcl_td_tnfw4602_2_fwvga_pt_init(void)
{
	int ret;

	if (msm_fb_detect_client("mipi_video_tcl_td_tnfw4602_2_fwvga"))
		return 0;
	...
	ret = mipi_tcl_td_tnfw4602_2_device_register(&pinfo, MIPI_DSI_PRIM,
...
module_init(mipi_video_tcl_td_tnfw4602_2_fwvga_pt_init);
